...
def on_message_received(topic, payload, dup, qos, retain, **kwargs):
    ...
    block.index = payload_dict['index']
    block.transactions = payload_dict['transactions'].copy
    block.timestamp = payload_dict['timestamp']
    block.previous_hash = payload_dict['previous_hash']
    block.nonce = payload_dict['nonce']
    block.hash = payload_dict['hash']
    blocks.append(block)
